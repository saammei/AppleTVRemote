...
nonisolated struct SetDefaultSupportedCommandsMessage: @unchecked Sendable {
...
nonisolated extension ProtocolMessageMessage {
  ...
  var setDefaultSupportedCommandsMessage: SetDefaultSupportedCommandsMessage {
  ...
  var hasSetDefaultSupportedCommandsMessage: Bool {
  ...
  mutating func clearSetDefaultSupportedCommandsMessage() {
...
nonisolated let SetDefaultSupportedCommandsMessage_Extensions: SwiftProtobuf.SimpleExtensionMap = [
...
nonisolated let Extensions_setDefaultSupportedCommandsMessage = SwiftProtobuf.MessageExtension<SwiftProtobuf.OptionalMessageExtensionField<SetDefaultSupportedCommandsMessage>, ProtocolMessageMessage>(
...
nonisolated extension SetDefaultSupportedCommandsMessage: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  static let protoMessageName: String = "SetDefaultSupportedCommandsMessage"
  ...
  static func ==(lhs: SetDefaultSupportedCommandsMessage, rhs: SetDefaultSupportedCommandsMessage) -> Bool {
