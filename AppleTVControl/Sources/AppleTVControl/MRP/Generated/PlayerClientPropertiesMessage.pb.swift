...
// MARK: - Extension support defined in PlayerClientPropertiesMessage.proto.
...
// MARK: - File's ExtensionMap: PlayerClientPropertiesMessage_Extensions
...
nonisolated extension PlayerClientPropertiesMessage: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  mutating func decodeMessage<D: SwiftProtobuf.Decoder>(decoder: inout D) throws {
    while let fieldNumber = try decoder.nextFieldNumber() {
      ...
      case 2: try { try decoder.decodeSingularDoubleField(value: &self._lastPlayingTimestamp) }()
      default: break
      }
    }
  }
